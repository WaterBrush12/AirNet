...
@app.get("/map_mobile")
def read_map_page(request: Request):
    """Serves the map_mobile page."""
    return templates.TemplateResponse("map_mobile.html", {"request": request})
...
@app.get("/sensors_mobile")
def read_sensors_page(request: Request):
    """Serves the sensors page."""
    return templates.TemplateResponse("sensors_mobile.html", {"request": request})
